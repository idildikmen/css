...
The project utilizes Natural Language Processing (BERT embeddings and K-Means clustering) to categorize EU policy initiatives and employs Poisson regression models with robust standard errors to analyze participation heterogeneity among citizens, NGOs, companies and business associations.
